...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post bugs_url, params: { bug: { descricao: @bug.descricao, nome: @bug.nome, projeto_id: @bug.projeto_id, solucao: @bug.solucao } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { descricao: @bug.descricao, nome: @bug.nome, projeto_id: @bug.projeto_id, solucao: @bug.solucao } }
